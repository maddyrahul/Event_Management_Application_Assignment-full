        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegisteredEventsEventId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventAttendees", x => new { x.AttendeesId, x.RegisteredEventsEventId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EventAttendees_Events_RegisteredEventsEventId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GuestListId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    EventId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GuestLists_AspNetUsers_AttendeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventAttendees_RegisteredEventsEventId",
